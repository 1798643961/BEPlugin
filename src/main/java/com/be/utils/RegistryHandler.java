...
public class RegistryHandler {
    ...
    public static void initPlant(String rawName, String name, ChatColor color, PlantType type, String texture) {
        ...
        SlimefunItemStack bush = new SlimefunItemStack(enumStyle + "_BUSH", Material.OAK_SAPLING, color + name + "植物", new String[0]);
        ...
        (new ExoticGardenFruit(BEItemGroups.mainItemGroup, new SlimefunItemStack(enumStyle, texture, color + name, new String[0]), ExoticGardenRecipeTypes.HARVEST_BUSH, true, new ItemStack[]{null, null, null, null, getItem(enumStyle + "_BUSH"), null, null, null, null})).register(BEPlugin.getInstance());
    }
    ...
    public static void initTree(String rawName, String name, String texture, String color, Color pcolor, String juice, boolean pie, Material... soil) {
        ...
        SlimefunItemStack sapling = new SlimefunItemStack(id + "_SAPLING", Material.OAK_SAPLING, color + name + " 树苗", new String[0]);
        ...
        (new ExoticGardenFruit(BEItemGroups.mainItemGroup, new SlimefunItemStack(id, texture, color + name, new String[0]), ExoticGardenRecipeTypes.HARVEST_TREE, true, new ItemStack[]{null, null, null, null, getItem(id + "_SAPLING"), null, null, null, null})).register(BEPlugin.getInstance());
        if (pcolor != null) {
            (new Juice(BEItemGroups.drinksItemGroup, new SlimefunItemStack(juice.toUpperCase().replace(" ", "_"), new CustomPotion(color + juice, pcolor, new PotionEffect(PotionEffectType.SATURATION, 6, 0), new String[]{"", "&7&o恢复 &b&o3.0 &7&o点饥饿值"})), RecipeType.JUICER, new ItemStack[]{getItem(id), null, null, null, null, null, null, null, null})).register(BEPlugin.getInstance());
        }

        if (pie) {
            (new CustomFood(BEItemGroups.foodItemGroup, new SlimefunItemStack(id + "_PIE", "3418c6b0a29fc1fe791c89774d828ff63d2a9fa6c83373ef3aa47bf3eb79", color + name + " 派", new String[]{"", "&7&o恢复 &b&o6.5 &7&o点饥饿值"}), new ItemStack[]{getItem(id), new ItemStack(Material.EGG), new ItemStack(Material.SUGAR), new ItemStack(Material.MILK_BUCKET), SlimefunItems.WHEAT_FLOUR, null, null, null, null}, 13)).register(BEPlugin.getInstance());
        }
    ...
    private static void saveSchematic(@Nonnull String id) {
        try {
            ...
            BEPlugin.getInstance().getLogger().log(Level.SEVERE, var10, () -> {
                return "Failed to load file: \"" + id + ".schematic\"";
            });
        }
